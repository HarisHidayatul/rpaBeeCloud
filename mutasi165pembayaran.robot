...
${child_url}    /robot/api/mutasi165/pembayaran/show
${Tanggal}    00-00-00
${Termin}    kosong
${loopCount}    ${0}
...
Get API Pembayaran Kemudian Lakukan Input Data
    FOR    ${infinityLoop}    IN RANGE    9999
        ...
        ${idRobot165Pembayaran}=    convert to string    ${contentData['idRobot165Pembayaran']}
        ...
        ${response2}=    get request    myssion2    /robot/api/mutasi165/pembayaran/done/${idRobot165Pembayaran}
