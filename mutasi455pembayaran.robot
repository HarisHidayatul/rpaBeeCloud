...
${child_url}    /robot/api/mutasi455Pembayaran/show
${Tanggal}    00-00-00
${Termin}    kosong
${loopCount}    ${0}
...
Get API Pembayaran Kemudian Lakukan Input Data
    FOR    ${infinityLoop}    IN RANGE    9999
        ...
        ${idRobotMutasi455Pembayaran}=    convert to string    ${contentData['idRobotMutasi455Pembayaran']}
        ...
        #Pilih kas bank
        click element    xpath://*[@id="s2id_dlgpaymtd_refid_bank"]/a
        ...
        ${response2}=    get request    myssion2    /robot/api/mutasi455Pembayaran/done/${idRobotMutasi455Pembayaran}
