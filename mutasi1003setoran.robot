...
${child_url}    /robot/api/mutasi1003/setoran/show
${Tanggal}    00-00-00
${Termin}    kosong
${loopCount}    ${0}
*** Keywords ***
...
Get API Mutasi 455 Transfer Kas Kemudian Lakukan Input Data
    FOR    ${infinityLoop}    IN RANGE    9999
        ...
        ${idRobotMutasi1003}=    convert to string    ${contentData['idRobotMutasi1003']}
        ...
        ${response2}=    get request    myssion2    /robot/api/mutasi1003/setoran/done/${idRobotMutasi1003}
