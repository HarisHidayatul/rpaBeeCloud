...
${child_url}    /robot/api/mutasi455TfKas/show
${Tanggal}    00-00-00
${Termin}    kosong
${loopCount}    ${0}
*** Keywords ***
...
Get API Mutasi 455 Transfer Kas Kemudian Lakukan Input Data
    FOR    ${infinityLoop}    IN RANGE    9999
        ...
        ${idRobotMutasi455TfKas}=    convert to string    ${contentData['idRobotMutasi455TfKas']}
        ...
        ${response2}=    get request    myssion2    /robot/api/mutasi455TfKas/done/${idRobotMutasi455TfKas}
